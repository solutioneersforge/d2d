...
export const routes: Routes = [
  ...
  { path: 'dashboard', component: ReportDashboardComponent, canActivate: [AuthGuardService]  },
  ...
  { path: 'reports', component: ReceiptProcessDashboardComponent, canActivate: [AuthGuardService]},
